...
export ICON_TELEGRAM= # telegram messenger
export ICON_CHAT=󰍩 # messages, teams, discord
...
export ICON_WIFI_DISCONNECTED=󰖪
export ICON_VPN=󰦝 # vpn, nordvpn

export ICONS_VOLUME=(󰸈 󰕿 󰖀 󰕾)

export ICONS_BATTERY=(􀛪 􀛩 􀺶 􀺸 􀛨)
